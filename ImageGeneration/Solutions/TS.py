...
def textureSynthesisA (n_iters, log_every, cnn, target, gramm_targets, layers_weights):
...
def textureSynthesisB (n_iters, log_every, cnn, target, gramm_targets, layers_weights):
...
def textureSynthesisC (n_iters, log_every, cnn, target, gramm_targets, layers_weights):
