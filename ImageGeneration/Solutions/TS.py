...
def textureSynthesisA (n_iters, log_every, synth, cnn, target, gramm_targets, outputs, layers, layers_weights, optimizer, _iter):
...
def textureSynthesisB (n_iters, log_every, synth, cnn, target, gramm_targets, outputs, layers, layers_weights, optimizer, _iter):
...
def textureSynthesisC (n_iters, log_every, synth, cnn, target, gramm_targets, outputs, layers, layers_weights, optimizer, _iter):
